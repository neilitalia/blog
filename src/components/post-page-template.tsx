...
const PostPage: React.FC<PostPageTemplateProps> = ({ data }) => {
  ...
  return (
    <Layout>
      {frontmatter.alt && frontmatter.featuredImage?.childImageSharp.fluid.src && <img src={frontmatter.featuredImage?.childImageSharp.fluid.src} alt={frontmatter.alt} className="w-full rounded-lg mb-7"/>}
